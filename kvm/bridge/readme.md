...
nmcli connection
sudo nmcli connection add type bridge-slave ifname enp3s0 master vir0 && sudo nmcli connection down enp3s0 && sudo nmcli connection up vir0 && nmcli connection
```